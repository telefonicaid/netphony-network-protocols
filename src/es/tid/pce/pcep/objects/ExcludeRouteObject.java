...
public class ExcludeRouteObject extends PCEPObject {
	...
	public void encode() {
		...
		log.finest("XROSubobjectList size is "+XROSubobjectList.size());
		...
		while (!fin) {
			...
			switch(subojectclass) {
				...
				case XROSubObjectValues.XRO_SUBOBJECT_UNNUMBERED_IF_ID:
					log.finest("UNNUMBERED IF ID FOUND");
				...
				default:
					log.finest("XRO Subobject Unknown");
					fin=true;
					//FIXME What do we do??
					break;
			}
