...
/**
 * LSP Instantiation Request {@code 
...
public class LSPInstantationRequest extends PCEPConstruct {
	...
	/**
	 * Default constructor. Use this method to create a new Request from scratch
	 */
	 ...
	 * @param bytes  bytes
	 * @param offset offset
	 * @throws PCEPProtocolViolationException Exception when the bytes do not lead
	 *                                        to a valid PCEP Request Construct
	 */
