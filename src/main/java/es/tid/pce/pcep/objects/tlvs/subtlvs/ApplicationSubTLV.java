...
version number on 6 bits and a build/fix version number on 6 bits.
   ...
   |           Type (TBD)          |           Length              |
   +-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
   |          Appl Type              | mj-rv |  mn-rv    | build/fix |
   +-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
...
public class ApplicationSubTLV extends PCEPSubTLV {
	...
	public ApplicationSubTLV(){
		this.setSubTLVType(PCEPSubTLVTypes.PCEP_SUBTLV_TYPE_APPLICATION);
		
	}
	
	public ApplicationSubTLV(byte[] bytes, int offset){
		super(bytes,offset);
		decode();
	}
	...
	public void encode() {
		...
		this.encodeHeader();
		System.arraycopy(ApplType, 0, this.subtlv_bytes, 4, 2);
	...
	public void decode() {
		ApplType=new byte[2];
		System.arraycopy(this.subtlv_bytes, 4, this.ApplType, 0, 2);
