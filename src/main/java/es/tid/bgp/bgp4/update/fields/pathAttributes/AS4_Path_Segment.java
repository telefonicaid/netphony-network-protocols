 ...
 *
 * @author Jose-Juan Pedreno-Manresa + ogondio + andrea
 */
public class AS4_Path_Segment implements BGP4Element
{
	private int  type;
	...
	public AS4_Path_Segment()
	{
		type = PathAttributesTypeCode.PATH_ATTRIBUTE_ASPATH_AS_SEQUENCE;
	} //Type and number, and nothing else;

	public AS4_Path_Segment(byte[] bytes, int offset) throws MalformedBGP4ElementException
	{
		 ...
		 * Total length = 2 + numberOfSegments*4 octets
		 */
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		AS4_Path_Segment other = (AS4_Path_Segment) obj;
