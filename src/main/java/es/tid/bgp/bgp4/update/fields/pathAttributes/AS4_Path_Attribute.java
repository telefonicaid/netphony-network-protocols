 ...
 * @author mcs
 */
public class AS4_Path_Attribute extends PathAttribute
{
	private List<AS4_Path_Segment> asPathSegments;

	public AS4_Path_Attribute()
	{
		super();
		//Poner los flags. 
		this.typeCode = PathAttributesTypeCode.PATH_ATTRIBUTE_TYPECODE_AS4PATH;
		asPathSegments = new LinkedList<AS4_Path_Segment>();
	}

	public AS4_Path_Attribute(byte[] bytes, int offset) throws MalformedBGP4ElementException
	{
		super(bytes, offset);
		asPathSegments = new LinkedList<AS4_Path_Segment>();
		decode();
	...
	public void encode()
	{
		...
		for(AS4_Path_Segment asPathSegment : asPathSegments)
		{
	...
	public void decode() throws MalformedBGP4ElementException
	{
		...
		while(offset < length)
		{
			AS4_Path_Segment asPathSegment = new AS4_Path_Segment(bytes, offset);
	...
	public List<AS4_Path_Segment> getAsPathSegments(){ return asPathSegments; }

	public void setAsPathSegments(List<AS4_Path_Segment> asPathSegments)
	{
	...
	public boolean equals(Object obj)
	{
		...
		if(getClass() != obj.getClass())
			return false;
		AS4_Path_Attribute other = (AS4_Path_Attribute) obj;
