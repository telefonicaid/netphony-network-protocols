...
public class LocalNodeDescriptorsTLV extends BGP4TLVFormat{
    ...
    public void decode(){
        ...
        int limit = this.getTLVValueLength() + 4;
        ...
        while (!fin) {
            ...
            switch(subtlvType) {
                ...
                case NodeDescriptorsSubTLVTypes.NODE_DESCRIPTORS_SUBTLV_TYPE_IGP_ROUTER_ID:
                    ...
                    // Log añadido para confirmar que el Speaker está procesando la 515
                    log.info("Sub-TLV 515 (IGP Router ID) encontrada: " + IGPRouterID.toString());
                    break;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(getTLVType(), autonomousSystemSubTLV, BGPLSIDSubTLV, AreaID, IGPRouterID);
    }
    ...
    public String toString() {
        ...
        sb.append("LocalNodeDescriptors: ");
        
        if (autonomousSystemSubTLV != null)
            sb.append(autonomousSystemSubTLV.toString()).append(" ");
            
        if (BGPLSIDSubTLV != null)
            sb.append(BGPLSIDSubTLV.toString()).append(" ");
            
        if (AreaID != null)
            sb.append(AreaID.toString()).append(" ");
        
        if (IGPRouterID != null)
            sb.append(IGPRouterID.toString()).append(" ");
