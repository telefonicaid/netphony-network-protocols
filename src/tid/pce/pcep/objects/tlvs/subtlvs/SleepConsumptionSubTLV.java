...
public class SleepConsumptionSubTLV extends PCEPSubTLV {
	...
	public SleepConsumptionSubTLV(){
		this.setSubTLVType(PCEPSubTLVTypes.PCEP_SUBTLV_TYPE_SLEEP_CONSUMPTION);
	...
	public void encode() {
		...
		this.encodeHeader();
		System.arraycopy(sleep, 0, this.subtlv_bytes, 4, 4);
	}

	
	public void decode() {
		System.arraycopy(this.subtlv_bytes, 4, this.sleep, 0, 4);
	}
