...
public class SessionAttributeWResourceAffinities extends SessionAttribute{
	...
	public SessionAttributeWResourceAffinities(int excludeAny, int includeAny, int includeAll, int setupPriority, int holdingPriority, int flags, String sessionName){
		...
		log.finest("Session Attribute With Resource Affinities Object Created");
   ...
   +-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
	...
	public void encode() throws RSVPProtocolViolationException{
		...
		log.finest("Starting Session Attribute With Resource Affinities encode");
		...
		log.finest("Encoding Session Attribute With Resource Affinities accomplished");
   ...
   +-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+</p>
	...
	public void decode(byte[] bytes, int offset) throws RSVPProtocolViolationException{
		...
		log.finest("Starting Session Attribute With Resource Affinities decode");
		...
		log.finest("Decoding Session Attribute With Resource Affinities accomplished");
