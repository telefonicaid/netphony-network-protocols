...
public class SubObjectValues {
	...
	public static final int ERO_SUBOBJECT_SWITCH_ID=55;//From my imagination
	public static final int ERO_SUBOBJECT_SWITCH_ID_EDGE=56;//From my big imagination
	public static final int ERO_SUBOBJECT_SWITCH_ID_END=57;//My imaginations is still flowing
