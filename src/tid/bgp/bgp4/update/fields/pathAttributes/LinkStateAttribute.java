...
import tid.bgp.bgp4.update.tlv.linkstate_attribute_tlvs.IPv4RouterIDLocalNodeNodeAttribTLV;
...
import tid.bgp.bgp4.update.tlv.linkstate_attribute_tlvs.LinkStateAttributeTLVTypes;
...
public class LinkStateAttribute  extends PathAttribute{
	...
	OSPFForwardingAddressPrefixAttribTLV OSPFForwardingAddrTLV;
		...
		public void encode() {
			...
			log.info("Available labels null?");
			...
			if (availableLabels != null){
				...
				log.info("Path attribute length");
			...
			while (!fin) {
				...
				//diferenciar en links y nodes para que no de error de compilacion ya que los id de los IPv4 son iguales 
					...
					*/
					...
					case LinkStateAttributeTLVTypes.BGP4_TLV_TYPE_AVAILABLELABELS:
		...
		public String toString() {
			...
			if (availableLabels!=null){
				...
				sb.append("There is not availableLabels");
